...
public class VisionAnalyticsPipeline {
  ...
  public static final Counter totalFiles =
      Metrics.counter(VisionAnalyticsPipeline.class, "totalFiles");
  public static final Counter rejectedFiles =
      Metrics.counter(VisionAnalyticsPipeline.class, "rejectedFiles");
  public static final Counter numberOfRequests =
      Metrics.counter(VisionAnalyticsPipeline.class, "numberOfRequests");
  ...
  private static final String ACCEPTED_FILE_PATTERN =
  ...
  static void collectBatchStatistics(
      PCollection<Iterable<String>> batchedImageURIs, VisionAnalyticsPipelineOptions options) {

    PCollection<TableRow> batchInfo =
        batchedImageURIs.apply(
            "Collect Batch Stats",
            ParDo.of(
                new DoFn<Iterable<String>, TableRow>() {
                  private static final long serialVersionUID = 1L;

                  @ProcessElement
                  public void processElement(
                      @Element Iterable<String> element,
   ...
   * VisionAnalyticsPipeline#ACCEPTED_FILE_PATTERN}.
   *
   * @return PCollection of GCS URIs
   */
