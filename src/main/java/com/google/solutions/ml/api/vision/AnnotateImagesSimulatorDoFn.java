 ...
 */
public class AnnotateImagesSimulatorDoFn
    extends DoFn<Iterable<String>, KV<String, AnnotateImageResponse>> {
  ...
  public void processElement(
      @Element Iterable<String> imageUris, OutputReceiver<KV<String, AnnotateImageResponse>> out) {
